...
python main_recon.py --phase train --model ReconFormer --gpu 0 --epochs 50 --challenge singlecoil --bs 1 --F_path /home/jschopme/dl/cs7643-fastmri/ReconFormer-main/data/ --train_dataset F --test_dataset F --sequence PD --accelerations 4 --center-fractions 0.08 --lr 0.0002 --lr-step-size 5 --lr-gamma 0.9 --save_dir ./ --verbose
