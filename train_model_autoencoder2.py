...
from models.singlecoil_kspace_transformer_autoencoder2 import SingleCoilKspaceTransformerAutoencoder2
...
configs = [
{
    'tags': ['autoencoder2'], # ['transformer1', 'loss', 'psnr']
    # Data parameters
...
def train_model():
    for CONFIG in configs:
        ...
        model = SingleCoilKspaceTransformerAutoencoder2(
